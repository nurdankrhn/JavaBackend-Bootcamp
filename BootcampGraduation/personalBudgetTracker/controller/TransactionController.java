...
public class TransactionController {
    ...
    @GetMapping("/monthly/report/full")
    public ResponseEntity<MonthlyReport> getFullMonthlyReport(
            @RequestParam Long userId,
            @RequestParam int month,
            @RequestParam int year) {

        MonthlyReport report = transactionService.getMonthlyReport(userId, month, year);
